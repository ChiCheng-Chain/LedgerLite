...
- ![流水页（含回收站入口）](screenshots/ledger-list-with-trash.png) — **ledger-list-with-trash.png**：时间筛选 + 分类筛选行对侧的回收站 chip 入口，按日分组的流水卡片

## 资产

- ![资产列表](screenshots/bigitem-list.png) — **bigitem-list.png**：当前使用成本汇总 + 单件资产日均/周均/已使用天数

## 统计

- ![分类占比](screenshots/stats-category-pie.png) — **stats-category-pie.png**：本月合计 + 分类占比环形图
- ![趋势与热力图](screenshots/stats-trend-heatmap.png) — **stats-trend-heatmap.png**：近 30 天支出趋势 + 近 12 周热力图 + 资产使用成本
