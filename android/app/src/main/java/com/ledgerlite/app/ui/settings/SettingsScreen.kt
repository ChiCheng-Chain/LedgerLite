    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                Text("分类管理", style = MaterialTheme.typography.bodyLarge, color = MaterialTheme.colorScheme.onBackground)
                androidx.compose.material3.TextButton(onClick = onOpenCategoryManage) {
                    Text("管理")
                }
            }
        }
