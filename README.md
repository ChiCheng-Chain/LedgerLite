...
v0.1.1 实机走查，按页面分组，完整索引见 [docs/screenshots.md](docs/screenshots.md)。

| | | | |
|:---:|:---:|:---:|:---:|
| ![记账](docs/screenshots/record-home.png) | ![快速记账](docs/screenshots/record-quick-entry.png) | ![流水](docs/screenshots/ledger-list-with-trash.png) | ![资产](docs/screenshots/bigitem-list.png) |
| 记账 | 快速记账 | 流水 | 资产 |
